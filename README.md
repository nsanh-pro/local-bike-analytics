...
Configuring Google Service Account to allow dbt to use Google BigQuery as the target datawarehouse
Configuring dbt configuration files:
  ...
  - schema.yml: for each subfolder in `\models`, describing models, columns and generic tests. Part of the documentation has been generated using `codegen` package.
